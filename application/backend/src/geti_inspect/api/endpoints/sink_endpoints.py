...
from geti_inspect.api.dependencies import get_configuration_service, get_project_id, get_sink_id
from geti_inspect.pydantic_models import Sink, SinkType
from geti_inspect.pydantic_models.sink import SinkAdapter, SinkCreate, SinkCreateAdapter
