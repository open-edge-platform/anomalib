...
In the original experiments, two datasets featuring RGB images are used:
...
This implementation integrates **L2BT** into the **anomalib** framework following the standard model interface.
