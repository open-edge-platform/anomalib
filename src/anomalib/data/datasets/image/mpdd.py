...
class MPDDDataset(AnomalibDataset):
    ...
    def __init__(
        ...
        self.split = split
        self.samples = make_mpdd_dataset(
            self.root_category,
            split=self.split,
...
def make_mpdd_dataset(
    ...
    Example:
        >>> root = Path("./datasets/MPDD/bracket_black")
        >>> samples = make_mpdd_dataset(root, split="train")
        >>> samples.head()
           path                split label image_path           mask_path label_index
        0  datasets/MPDD/bracket_black train good  [...]/good/105.png           0
        1  datasets/MPDD/bracket_black train good  [...]/good/017.png           0
