...
type NORMALIZATION = NormalizationMethod | DictConfig | Callback | str
type THRESHOLD = Threshold | tuple[Threshold, Threshold] | DictConfig | ListConfig | list[dict[str, str | float]] | str
