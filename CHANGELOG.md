...
- 🚀 **model**: add automatic download of DTD dataset to DRAEM model in https://github.com/open-edge-platform/anomalib/pull/2866
- 🚀 **metric**: added histogram of anomaly scores in https://github.com/open-edge-platform/anomalib/pull/2920
- 🚀 **metric**: added PGn, PBn metrics in https://github.com/open-edge-platform/anomalib/pull/2889
- 🚀 **data**: added ground truth masks to VAD dataset in https://github.com/open-edge-platform/anomalib/pull/2940
- 🚀 **workflow**: add CodeQL analysis workflow for security scanning in https://github.com/open-edge-platform/anomalib/pull/2951
- 🚀 **data**: add backward compatibility methods and update docstring examples in https://github.com/open-edge-platform/anomalib/pull/2950

### Fixed

- 🐞 **data**: Perlin noise generator masks in https://github.com/open-edge-platform/anomalib/pull/2936
- 🐞 **deploy**: Fix openvino cache directory in https://github.com/open-edge-platform/anomalib/pull/2979
- 🐞 **utils**: Run CS Flow model in eval() so the weights of the model itself will not be modified in https://github.com/open-edge-platform/anomalib/pull/2966
- 🐞 **ci**: ignore uv.lock in semgrep in https://github.com/open-edge-platform/anomalib/pull/2972
- 🐞 **docs**: revert correct symlink and update pre-commit config in https://github.com/open-edge-platform/anomalib/pull/2875
  - 🐞 **deploy**: Fix discrepancy between lightning and standalone inferencers in https://github.com/open-edge-platform/anomalib/pull/2843
- 🐞 **docs**: revert correct symlink in https://github.com/open-edge-platform/anomalib/pull/2854
- 🐞 **imports**: update OpenVINO import paths in inferencer and post-processor in https://github.com/open-edge-platform/anomalib/pull/2829, in https://github.com/open-edge-platform/anomalib/pull/2789
- 🐞 **data**: MVTecAD2 CLI bug fix enum serialisation in https://github.com/open-edge-platform/anomalib/pull/2817
- 🐞 **model**: remove in-place ops in CombinedDensityEstimator.predict for ONNX dynamic_axes export in https://github.com/open-edge-platform/anomalib/pull/2808
- 🐞 **export**: enhance model export with flexible kwargs support for ONNX and OpenVINO in https://github.com/open-edge-platform/anomalib/pull/2780
- 🐞 **visualization**: modify the image font loading logic to ensure the right font is installed in https://github.com/open-edge-platform/anomalib/pull/2783
- 🐞 **data**: enhance ToNumpyMixin for improved tensor conversion in https://github.com/open-edge-platform/anomalib/pull/2775
- 🐞 **docs**: fixed the "Anomalib in 15 Minutes" train and inference code in https://github.com/open-edge-platform/anomalib/pull/2904
- 🐞 **metric**: fixed examples to work with Anomalib metrics in https://github.com/open-edge-platform/anomalib/pull/2911
- 🐞 **model**: Reduce memory reserved for memory bank based models PatchCore, Padim, Dfkde in https://github.com/open-edge-platform/anomalib/pull/2913
- 🐞 **bandit**: Suppress Bandit NoSec incorrectly flagging HuggingFace model loading in https://github.com/open-edge-platform/anomalib/pull/2937, in https://github.com/open-edge-platform/anomalib/pull/2947
- 🐞 **docs**: Update documentation and log messages to reflect recent changes in https://github.com/open-edge-platform/anomalib/pull/2931
- 🐞 **path**: Remove filter to remove hidden files in https://github.com/open-edge-platform/anomalib/pull/2955
- 🐞 **utils**: Improve optional import handling across loggers and model backends in https://github.com/open-edge-platform/anomalib/pull/2956, in https://github.com/open-edge-platform/anomalib/pull/2954

### Changed

- 🔧 **visualizer**: remove unnecessary warning log in `visualize_image_item` in https://github.com/open-edge-platform/anomalib/pull/2778
- 🔧 **model**: check if no normalization is in transforms for DRAEM, DSR in https://github.com/open-edge-platform/anomalib/pull/2867
- 📦 **pyproject.toml**: Select files in source distribution for builds in https://github.com/open-edge-platform/anomalib/pull/2869
- 🔧 **deps**: update github actions in https://github.com/open-edge-platform/anomalib/pull/2921
