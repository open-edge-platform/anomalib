...
class TestPatchflowModel:
    """Tests for PatchflowModel."""

    def test_initialization(self, model: PatchflowModel) -> None:
        """Test that the model initialises without errors."""
        assert isinstance(model, PatchflowModel)
        assert model.input_size == (224, 224)

    def test_forward_train(self, model: PatchflowModel, input_tensor: torch.Tensor) -> None:
    ...
    def test_forward_eval(self, model: PatchflowModel, input_tensor: torch.Tensor) -> None:
    ...
    def test_no_nan_in_output(self, model: PatchflowModel, input_tensor: torch.Tensor) -> None:
